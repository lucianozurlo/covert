  ...
  addParallaxMedia(elem = null, options = {}) {
    ...
    const item = {
      ...
      update: function (cs) {
        ...
        this.$el.css("transform", "translateY(" + this.scrollPath * t + "px)");
      },
    };
        ...
        (this.i_scale =
          ...
          (this.i_clip =
            50 - (this.$el.css("--st-eos-init-clip") !== undefined)
              ...
              : 12.5),
          (this.br =
            this.$el.css("--st-eos-br") !== undefined // 12.5 = 25% vissibility or 0.25 in styles; 50 - fully collapsed, 0 - fully visible
